...
const categories = [
  {
    ...
    name: "Kilos",
    image:
      "https://rukminim1.flixcart.com/flap/128/128/image/29327f40e9c4d26b.png",
  },
  {
    id: 2,
    name: "Mobiles",
    image:
      "https://rukminim1.flixcart.com/flap/128/128/image/22fddf3c7da4c4f4.png",
  },
  {
    id: 3,
    name: "Fashion",
    image:
      "https://rukminim1.flixcart.com/flap/128/128/image/c12afc017e6f24cb.png",
  ...
  },
  {
    ...
    name: "Electronics",
    image:
      "https://rukminim1.flixcart.com/flap/128/128/image/69c6589653afdb9a.png",
  ...
  },
  {
    ...
    name: "Home & Furniture",
    image:
      "https://rukminim1.flixcart.com/flap/128/128/image/ab7e2b022a4587dd.jpg",
  ...
  },
  {
    ...
    name: "Appliances",
    image:
      "https://rukminim1.flixcart.com/flap/128/128/image/0ff199d1bd27eb98.png",
  },
  {
    id: 7,
    name: "Flight Bookings",
    image:
      "https://rukminim1.flixcart.com/flap/128/128/image/71050627a56b4693.png",
  },
  {
    id: 8,
    name: "Beauty, Toys & More",
    image:
      "https://rukminim1.flixcart.com/flap/128/128/image/dff3f7adcf3a90c6.png",
  },
  {
    id: 9,
    name: "Two Wheelers",
    image:
      "https://rukminim1.flixcart.com/fk-p-flap/128/128/image/05d708653beff580.png",
  },
];
                ...
                {expandedCategory === category.id && category.subcategories && (
                  <ul className="mt-2 bg-white shadow-md rounded p-2 absolute z-10 w-40">
                    {category.subcategories.map((subcategory, index) => (
                      <li
                        key={index}
                        className="py-1 text-sm cursor-pointer hover:text-[#2874f0]"
                      >
                        {subcategory}
                      </li>
                    ))}
        ...
        <Slider {...productSliderSettings}>
          {electronics.map((product) => (
            ...
            >
              ...
              <h3 className="font-medium text-sm group-hover:text-[#2874f0] text-center">
                {product.title}
              </h3>
