  ...
  if (!user) {
    return (
      <div className="text-center mt-20">
        <h2 className="text-lg font-medium mb-4">Please log in to view your cart.</h2>
        <Link to="/login" className="bg-[#2874f0] text-white px-8 py-3 rounded font-medium">
          Login
        </Link>
      </div>
    );
      ...
      <div className="min-h-screen bg-[#f1f3f6] pt-20">
        <div className="max-w-5xl mx-auto p-6 bg-white shadow mt-4">
          <div className="text-center py-8">
            ...
            <Link to="/" className="bg-[#2874f0] text-white px-16 py-3 rounded-sm font-medium">
              Shop Now
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto p-4 flex gap-4">
        ...
        <div className="flex-1">
          <div className="bg-white shadow">
            <div className="p-4 border-b">
              <h1 className="text-lg font-medium">My Cart ({cartItems.length})</h1>
            </div>
        ...
        <div className="w-96">
          <div className="bg-white shadow p-4">
            <h2 className="text-gray-500 font-medium text-sm uppercase mb-4">PRICE DETAILS</h2>
